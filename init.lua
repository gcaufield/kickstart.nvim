...
require('lazy').setup({
  ...
  -- Alternatively, use `config = fujknction() ... end` for full control over the configuration.
  ...
  { -- Directory Exploration
    ...
    config = function() vim.keymap.set('n', '<leader>tn', ':Neotree toggle<CR>', { desc = '[T]oggle [N]eotree' }) end,
  },
  { --  Floating Terminal
